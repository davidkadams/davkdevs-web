...
const CHIPS: Chip[] = [
  { label: "Premiere Pro", slug: "adobepremierepro", bg: "#9999FF", fg: "#000000" },
  { label: "After Effects", slug: "adobeaftereffects", bg: "#9999FF", fg: "#000000" },
  { label: "Photoshop", slug: "adobephotoshop", bg: "#31A8FF", fg: "#ffffff" },
  { label: "DaVinci Resolve", slug: "davinciresolve", bg: "#233A52", fg: "#ffffff" },
  { label: "YouTube", slug: "youtube", bg: "#FF0000", fg: "#ffffff" },
  { label: "Instagram", slug: "instagram", bg: "#E4405F", fg: "#ffffff" },
];
